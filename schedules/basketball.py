...
class BasketballSchedule:
    ...
    def __init__(self, league, clubs, begin_date, end_date):
        ...
        self.match_url = "https://www.espn.com/nba/game/_/gameId/"

    def get_events(self) -> list:
        url = f"https://site.api.espn.com/apis/site/v2/sports/basketball/{self.league}/scoreboard?dates={self.begin_date}-{self.end_date}&limit=1000"
